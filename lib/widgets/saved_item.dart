...
class SavedItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Image.asset("${product.image}", width: 161, height: 172, fit: BoxFit.contain),
          Positioned(
            bottom: 0,
            child: Container(
              color: Colors.white,
              ...
              child: Column(
                children: [
                  ...
                  Align(
                    alignment: Alignment.centerLeft,
                    child: Text("\$ ${product.price}",style: TextStyle(fontSize: 12,
                    fontWeight: FontWeight(500),color: Color(0xff808080)),),
                  )
                ]
              ),
            ),
